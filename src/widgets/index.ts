...
import { mathCopyImageWidget } from "./math/copy-image-widget";

/** Add future widgets to this list; each module owns its parser, renderer and tests. */
export const widgets: readonly MarkdownWidget[] = [countdownWidget, inlineCountdownWidget, mathCopyImageWidget];
